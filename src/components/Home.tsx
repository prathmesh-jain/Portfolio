            ...
            <div className='mx-auto flex min-h-[calc(100svh-var(--nav-height))] max-w-7xl items-center'>
                <div className='grid w-full items-center gap-8 py-6 lg:grid-cols-[1.02fr_0.98fr] lg:py-8'>
                    ...
                    >
                        ...
                        <p className='section-copy mt-5 max-w-xl text-sm leading-7 sm:text-base sm:leading-8'>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className='relative aspect-[4/5] overflow-hidden rounded-[1.6rem]' style={{ transform: 'translateZ(26px)' }}>
                                <img
                                    src='/profile.jpg'
                                ...
                                <div
                                    className='glass-panel absolute left-4 top-4 rounded-2xl px-4 py-3 text-left sm:left-6 sm:top-6'
                                    style={{ transform: 'translateZ(34px)' }}
                                >
                                    <div className='text-[11px] uppercase tracking-[0.22em]' style={{ color: 'var(--text-soft)' }}>
                                        Current Role
                                    </div>
                                ...
                                <div
                                    className='glass-panel absolute bottom-4 right-4 rounded-2xl px-4 py-3 text-left sm:bottom-6 sm:right-6'
